...
// @types
import { ITransaction, ITransactionPagination } from '../../../../@types/transaction';
...
export default function CustomerTransactionalList({
  ...
  const changePageRequest = (event: unknown, newPage: number) => {
    ...
    console.log(customerTransactions.offset);

    if (newPage * rowsPerPage >= customerTransactions.data.length) {
      const offsetStart = customerTransactions.offset + 25;
    ...
    <>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <Card>
          ...
          <TablePaginationCustom
            count={customerTransactions.total}
            page={page}
...
function applyFilter({
  ...
  //     transaction.items.some((c) => c.service === filterService)
  //   );
  // }
