...
export default function AccountChangePassword() {
  ...
  const ChangePassWordSchema = Yup.object().shape({
    oldPassword: Yup.string().required('Nuværende adgangskode er påkrævet'),
    newPassword: Yup.string()
      .min(6, 'Adgangskoden skal mindst være på 6 tegn')
      .required('New Password is required'),
    confirmNewPassword: Yup.string().oneOf(
      [Yup.ref('newPassword'), null],
      'Adgangskoderne skal stemme overens'
    ),
  });
          ...
          <RHFTextField
            ...
            helperText={
              <Stack component="span" direction="row" alignItems="center">
                ...
                mindst være på 6 tegn
              </Stack>
            }
          />

          <RHFTextField name="confirmNewPassword" type="password" label="Godkend Ny Adgangskode" />
