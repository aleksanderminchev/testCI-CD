    ...
    try:
        ...
        for customer in customers:
            if customer.created_at <= date_check:
                ...
                net_revenue = average_hourly_price['average_hourly_price'] * accrued_hours
...
def calculate_revenue_generated(start_date, end_date):
    ...
    try:
        ...
        merged_dataframe = final_dataframe.merge(initial_dataframe,
                                                on=['ID', 'Customer Name', "Email"],
                                                how='outer').drop_duplicates(['ID','Customer Name','Email'])
        merged_dataframe['Diffrence in revenue'] = merged_dataframe['Revenue_x'] - merged_dataframe['Revenue_y']                
