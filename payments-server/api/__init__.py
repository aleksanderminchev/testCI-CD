"""
Welcome to the documentation for the TopTutors API PAYMENTS!

The TopTutors API is written in Python, with the
...
If you are running TopTutors API yourself while developing your front end,
...
| `CONFIRMATION_URL` | `https://localhost:3000/auth/confirmation The URL that will be used to confirm profiles for the platform.
...
| `MAIL_DEFAULT_SENDER` | `hej@toptutors.dk` | The default sender to use for emails. |
